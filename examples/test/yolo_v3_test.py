...
def main():
    ...
    Trainer(trainer_cfg, data, yolo_v3)

    # Step 3: detect
    yolo_v3.load("/home/yangxf/WorkSpace/machine_learning/checkpoints/yolov3/checkpoint_epoch_119.pth")
    yolo_v3.detect("/home/yangxf/WorkSpace/machine_learning/data/coco-2017/images/val/000000577182.jpg")
