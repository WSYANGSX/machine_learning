...
from machine_learning.dataset.parsers import VEDAIParser, YoloParserCfg
...
def main():
    ...
    parser_cfg = YoloParserCfg(dataset_dir="./data/VEDAI_1024", labels=True, tfs=tfs, multiscale=False)
    data = VEDAIParser(parser_cfg).create()  # (class_names, train_dataset, val_dataset)
