...
class FireHoleParser(ParserBase):
    r"""Fire_hole semantic segmentation data set parser."""
    ...
    def parse(self) -> dict[str, Any]:
        ...
        train_irs = [os.path.join(self.dataset_path, self.train_irs_dir) + f"/{id}.jpg" for id in self.train_ids]
        train_labels = [
            os.path.join(self.dataset_path, self.train_labels_dir) + f"/{id}_mask.png" for id in self.train_ids
        ]

        # val path
        val_imgs = [os.path.join(self.dataset_path, self.val_imgs_dir) + f"/{id}.jpg" for id in self.val_ids]
        val_irs = [os.path.join(self.dataset_path, self.val_irs_dir) + f"/{id}.jpg" for id in self.val_ids]
        val_labels = [os.path.join(self.dataset_path, self.val_labels_dir) + f"/{id}_mask.png" for id in self.val_ids]
